package role_info {
	...
	public dynamic final class ClientLoginRequest extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const PLAYER_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("role_info.ClientLoginRequest.player_id", "playerId", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PLAYER_PWD:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("role_info.ClientLoginRequest.player_pwd", "playerPwd", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const MD5_CODE:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("role_info.ClientLoginRequest.md5_code", "md5Code", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
